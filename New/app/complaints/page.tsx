...
import { mockComplaintsData, ComplaintItem } from '@/data/mockData';
...
export default function ComplaintsPage() {
  const [complaints, setComplaints] = useState<ComplaintItem[]>(mockComplaintsData);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-600">Crowdsourced grievance board for municipal accountability and rapid resolution</p>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-md w-full p-6 space-y-5 animate-in fade-in zoom-in duration-150">
            ...
            <form onSubmit={handleAddGrievance} className="space-y-4">
              ...
              <div className="flex items-start gap-2 p-3 bg-amber-50 rounded-lg border border-amber-200 text-xs text-amber-800">
                ...
                <span>Submitted grievances are publicly visible and logged for official departmental review.</span>
              </div>
